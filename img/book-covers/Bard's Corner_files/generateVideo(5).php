...
function plantVideo() {
	var currVideo = jQuery(
		'<div class="video-js-holder">'
			+ '<video id="video-241283220540729181" poster="/uploads/b/133054793-626939275514651421/audiobook_cover_743.jpg" class="video-js vjs-big-play-centered" style="display: none;">'
				+ '<source src="/uploads/b/133054793-626939275514651421/audiobook_cover_743.mp4" type="video/mp4" />'
			+ '</video>'
		+ '</div>'
	);
	parent.document.getElementById('wsite-video-container-241283220540729181').appendChild(currVideo.get(0));
	...
	var videoPlayer = videojs("video-241283220540729181", {
		"controls": true,
		"autoplay": false,
		'techOrder': ['html5','flash'],
		"preload": "none",
		"poster": "/uploads/b/133054793-626939275514651421/audiobook_cover_743.jpg",
		"width": 501,
		"height": 282
	}, function(){
		...
		if (ie8Mode) {
			...
			currVideo.find('.vjs-poster').css({
				'background-image': 'url("/uploads/b/133054793-626939275514651421/audiobook_cover_743.jpg")',
