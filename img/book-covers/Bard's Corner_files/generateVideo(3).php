...
if (typeof parent.videojs == 'undefined') {
	...
	videoJSStyle.setAttribute("href", "//cdn2.editmysite.com/css/videojs/video.4.3.css?buildTime=1639521509");
	...
	videoJSScript.setAttribute("src", "//www.weebly.com/weebly/libraries/videojs/video.4.3.js?buildTime=1639521509");
...
function firstVideo() {
	parent.videojs.options.flash.swf = '//www.weebly.com/weebly/libraries/videojs/video-js.swf?buildTime=1639521509';
	plantVideo();
}
...
function plantVideo() {
	var currVideo = jQuery(
		'<div class="video-js-holder">'
			+ '<video id="video-232291927422890947" poster="/uploads/b/133054793-626939275514651421/unite_the_party_headliner__made_by_headliner___1__347.jpg" class="video-js vjs-big-play-centered" style="display: none;">'
				+ '<source src="/uploads/b/133054793-626939275514651421/unite_the_party_headliner__made_by_headliner___1__347.mp4" type="video/mp4" />'
			+ '</video>'
		+ '</div>'
	);
	parent.document.getElementById('wsite-video-container-232291927422890947').appendChild(currVideo.get(0));
	...
	var videoPlayer = videojs("video-232291927422890947", {
		"controls": true,
		"autoplay": false,
		'techOrder': ['html5','flash'],
		"preload": "none",
		"poster": "/uploads/b/133054793-626939275514651421/unite_the_party_headliner__made_by_headliner___1__347.jpg",
		"width": 501,
		"height": 282
	}, function(){
		...
		if (ie8Mode) {
			...
			currVideo.find('.vjs-poster').css({
				'background-image': 'url("/uploads/b/133054793-626939275514651421/unite_the_party_headliner__made_by_headliner___1__347.jpg")',
